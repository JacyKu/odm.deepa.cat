...
function generateRegions(itemData) {
    ...
    Object.keys(itemData)
        .map((item) => itemData[item].region)
        .filter((regionName) => regionName != undefined)
        .forEach((regionName) => {
...
export default function LegacySearchForm({ update, itemData }) {
    ...
    return (
        <form
            ...
            onMouseDown={uncheckOthers}
            onTouchStart={uncheckOthersLongTouch}
            ...
            <div className={styles.inputs}>
                <div className={styles.checkboxes} title="Right-click a checkbox to deselect all others">
                    ...
                    <div className={styles.checkboxSubgroup}>
                        <CheckboxWithLabel
                            name="Offhand Shield"
                            translatableName="items.type.offhandShield"
                            checked={true}
                        />
                        <CheckboxWithLabel
                            name="Mainhand Shield"
                            translatableName="items.type.mainhandShield"
                            checked={true}
                        />
                        <CheckboxWithLabel
                            name="Mainhand Sword"
                            translatableName="items.type.mainhandSword"
                            checked={true}
                        />
                        <CheckboxWithLabel
                            name="Offhand Sword"
                            translatableName="items.type.offhandSword"
                            checked={true}
                        />
                    </div>
                    <div className={styles.checkboxSubgroup}>
